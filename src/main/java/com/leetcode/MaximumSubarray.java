...
public class MaximumSubarray {
    ...
    int maxSubArrayCubicTime(int[] nums){
...
//    --------------------------------------------
public int maxContiguousSubarraySumQuadraticTime(int[] nums) {
    int n = nums.length;
...
public int maxContiuousSubArraySumLinearTime(int[] nums){
//          /*
...
//    return maxSoFar;
        ...
        //loop over array
    //keep track of sum
    //compare sum+element to element => take greater value
    //return max value
    int maxSum = nums[0];
